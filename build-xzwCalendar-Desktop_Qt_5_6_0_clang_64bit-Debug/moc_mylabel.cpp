...
QT_MOC_LITERAL(3, 17, 14), // "double_clicked"
QT_MOC_LITERAL(4, 32, 11) // "sth_changed"

    },
    "MyLabel\0clicked\0\0double_clicked\0"
    "sth_changed"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->double_clicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->sth_changed(); break;
        default: ;
        }
        ...
        {
            typedef void (MyLabel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::double_clicked)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLabel::sth_changed)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void MyLabel::double_clicked(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
